...
<head>
    ...
    <style>
        /* ---------------------------------------------------------------- *
         *  Gestion de l'ordre d'affichage des menus et des tâches
         * ---------------------------------------------------------------- */
        .ordre-menu-list,
        .ordre-sub-list {
            list-style: none;
        ...
        .ordre-sub-list {
            border-top: 1px dashed rgba(17, 59, 38, .15);
        ...
        .ordre-item-tache {
            ...
            gap: 10px;
            background: #ffffff;
            border: 1px solid rgba(17, 59, 38, .08);
            border-radius: 8px;
            padding: 8px 12px;
        }
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                ...
                                <li class="breadcrumb-item text-muted">
                                    <span class="text-muted text-hover-primary">Ordre du menu</span>
                                </li>
                                    ...
                                    <div class="py-5">
                                        ...
                                        <div class="d-flex flex-stack mb-5 flex-wrap gap-3">
                                            <div class="d-flex align-items-center">
                                                <label for="selectApplication" class="form-label fw-bolder me-3 mb-0">Application</label>
                                                <select id="selectApplication" class="form-select form-select-solid w-250px">
                                                    <option value="">Choisir...</option>
                                                </select>
                                            </div>

                                            <button type="button" id="btnEnregistrerOrdre" class="btn btn-success">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none">
                                                        <path opacity="0.3" d="M19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H16L21 8V19C21 20.1 20.1 21 19 21Z" fill="black"/>
                                                        <path d="M14 3H8V7H14V3Z" fill="black"/>
                                                        <path d="M12 12C10.3 12 9 13.3 9 15C9 16.7 10.3 18 12 18C13.7 18 15 16.7 15 15C15 13.3 13.7 12 12 12Z" fill="black"/>
                                                    </svg>
                                                </span>
                                                Enregistrer l'ordre
                                            </button>
                                        ...
                                        <div id="zoneOrdreMenu">
                                            <div class="text-muted text-center py-10">
                                                Sélectionnez une application pour afficher son menu.
                                            </div>
                                        </div>
...
<script src="/personnel/scripts.bundle.15.js"></script>
</body>
