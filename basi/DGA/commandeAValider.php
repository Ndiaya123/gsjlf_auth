...
<head>
    ...
    <title>Validation des commandes — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_26.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Commandes en attente de validation (fournisseur retenu + prix réels)</p>
                            </div>
                        </div>
                        ...
                        <!-- MODALE : Validation de la commande -->
                        <div class="modal fade dga-modal" id="modalValiderCommande" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 id="dgaModalTitre">Validation de la commande</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- BLOC 1 : Choisir le bon fournisseur -->
                                        <div class="dga-bloc">
                                            <h3 class="dga-bloc-title">1. Choisir le bon fournisseur</h3>
                                            <div id="dgaListeFournisseurs" class="dga-fournisseurs">
                                                <p style="color:#9ca3af;font-style:italic;">Chargement…</p>
                                            </div>
                                        </div>

                                        <!-- BLOC 2 : Mise à jour des lignes de commande -->
                                        <div class="dga-bloc">
                                            <h3 class="dga-bloc-title">2. Mise à jour des lignes de commande</h3>
                                            <table class="dga-table">
                                                ...
                                                <tbody id="dgaBodyLignes"></tbody>
                                            </table>
                                            <div class="dga-total">
                                                <span class="lbl">Montant total :</span>
                                                <span class="val" id="dgaMontantTotal">0&nbsp;FCFA</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="dga-actions">
                                        ...
                                        <button type="button" class="dga-submit" id="dgaSubmitValider">
...
<script src="/personnel/basi-scripts.bundle.19.js"></script>
