                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex justify-content-end"
                                                ...
                                                <a href="#" class="btn btn-primary er fs-6 px-8 py-4"
                                                   data-bs-toggle="modal" data-bs-target="#kt_modal_new_sous_rubrique">Ajouter</a>
...
<div class="modal fade" id="kt_modal_new_sous_rubrique" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="formSousRubrique" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                               title="Le nom de la sous rubrique doit être unique."></i>
                        </label>
                        <input type="text" class="form-control" placeholder="" name="nom_sous_rubrique"
                               id="nom_sous_rubrique" value=""/>
                    </div>
                    <div class="d-flex flex-column mb-7 fv-row">Sous rubrique</label><br>
                        <select class="form-select" data-control="select2" data-placeholder="Choisir..." id="rubrique" name="rubrique">
                            <option></option>
                        </select>
                    </div>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" onclick="closeSousRubrique()">Annuler</button>
                        <button type="submit" id="formSousRubrique_submit" class="btn btn-primary">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="formSousRubriqueUpdate" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nom_sous_rubrique_up"
                               id="nom_sous_rubrique_up" value=""/>
                    </div>


                    <div class="d-flex flex-column mb-7 fv-row">Sous rubrique</label><br>
                        <select class="form-select" data-control="select2" data-placeholder="Choisir..." id="rubrique_up" name="rubrique_up">
                            <option></option>
                        </select>
                    </div>

                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" onclick="closeSousRubriqueUpdate()">Annuler</button>
                        <button type="submit" id="formSousRubriqueUpdate_submit" class="btn btn-primary">
