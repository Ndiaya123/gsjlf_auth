                                            ...
                                            <div class="bud-grid-2">
                                                ...
                                                <div class="bud-field">
                                                    ...
                                                    <select id="type_budget_id" name="type_budget_id" class="bud-inp">
                                                        <option value="" disabled selected>Investissement</option>
                                                    </select>
...
<!-- Config module Budget Investissement
     defaultType : ID du type "Investissement" dans la table TypeBudget
     La direction est gérée côté serveur depuis la session tmpIdDirection.
-->
<script>
    window.COMPTABLE_CONFIG = {
        defaultType: 2  // ← à ajuster selon l'ID réel du type "Investissement" en base
    };
</script>

<!-- Script métier budget -->
<script src="/personnel/basi-scripts.bundle.5.js"></script>
