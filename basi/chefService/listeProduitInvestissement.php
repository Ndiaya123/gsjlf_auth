...
<head>
    ...
    <title>Produits d'investissement — ENT GSJLF</title>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Stock disponible pour votre direction — sélectionnez et retirez directement</p>
                            </div>
                        </div>

                        <!-- ══ STATISTIQUE ══ -->
                        <div class="dga-stat-card" id="dga-stat-card-produits">
                            ...
                            <div>
                                <div class="dga-stat-lbl">Références en stock</div>
                                <div class="dga-stat-val" id="dga-stat-nb-produits">0</div>
                            </div>
                        </div>

                        <!-- ══ CARTE — TABLEAU DE STOCK ══ -->
                        <div class="dga-card">
                            ...
                            <table id="dga-table-stock" class="display" style="width:100%">
                                <thead>
                                <tr>
                                    <th>Produit</th>
                                    <th>Rubrique</th>
                        ...
                        <!-- ══ PANIER FLOTTANT ══ -->
                        <div id="dga-panier">
                            <div class="dga-panier-head">
                                <span class="dga-panier-titre">
                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>
                                    Votre demande
                                    <span class="dga-panier-badge" id="dga-panier-count">0</span>
                                </span>
                            </div>
                            <div class="dga-panier-liste" id="dga-panier-liste"></div>
                            <div id="dgaErreurPanier" class="dga-erreur-generale" style="display:none;"></div>
                            <div class="dga-panier-actions">
                                <button type="button" class="dga-submit-poursuivre" id="dga-btn-poursuivre">
                                ...
                                <button type="button" class="dga-submit-soumettre" id="dga-btn-terminer">
                        ...
                        <div class="dga-histo-toggle" id="dga-histo-toggle">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
                            Mes expressions de besoin (<span id="dga-histo-count">0</span>)
                        </div>
                        <div id="dga-histo-contenu">
                            <div class="dga-card">
                                <table id="dga-table-histo" class="display" style="width:100%">
                                    <thead>
                                    <tr>
                                        <th>Nom</th>
                        ...
                        <!-- ══ MODALE : Détail (lecture / poursuite) ══ -->
