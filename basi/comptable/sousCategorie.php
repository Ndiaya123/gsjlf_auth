...
<head>
    ...
    <link href="/personnel/ressources/dist_assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
          type="text/css"/>
    <link href="/personnel/ressources/dist_assets/css/style_basi_21.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Créez et gérez les sous-catégories de produits</p>
                            </div>
                            <a href="#" class="dga-btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_sous_categorie">
                        ...
                        <div class="dga-card">
                            ...
                            <div class="dga-table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 dga-table" id="table_sous_categorie">
                                        <thead>
                                        <tr class="fw-bolder text-muted">
                                            <th class="min-w-120px">N°</th>
                                            <th class="min-w-200px">Nom</th>
                                            <th class="min-w-200px">Catégorie</th>
...
<div class="modal fade dga-modal" id="kt_modal_new_sous_categorie" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Nouvelle sous-catégorie</h2>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"
                     onclick="closeSouscategorie()">
                    <span class="svg-icon svg-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="modal-body">
                <form id="formSouscategorie" class="form" action="#">
                    <input type="hidden" name="option" value="7"/>
                    <div class="dga-field fv-row">
                        <label>Nom <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Le nom de la sous categorie doit être unique."></i></label>
                        <input type="text" class="dga-inp form-control" placeholder="" name="nom_sous_categorie" id="nom_sous_categorie" value=""/>
                    </div>
                    <div class="dga-field fv-row">
                        <label>Catégorie</label>
                        <select class="dga-inp form-select" data-control="select2" data-placeholder="Choisir..." id="categorie" name="categorie">
                            <option></option>
                        </select>
                    </div>

                    <div class="dga-actions" style="padding:0;border-top:none;background:transparent;margin-top:1rem;">
                        <button type="reset" class="dga-cancel" onclick="closeSouscategorie()">Annuler</button>
                        <button type="submit" id="formSouscategorie_submit" class="dga-submit">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"
                     onclick="closeSouscategorieUpdate()">
                    <span class="svg-icon svg-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black"/>
                            <rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="black"/>
            ...
            <div class="modal-body">
                <form id="formSouscategorieUpdate" class="form" action="#">
                    ...
                    <div class="dga-field fv-row">
                        <label>Nom <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Le nom de la sous-categorie doit être unique."></i></label>
                        <input type="text" class="dga-inp form-control" placeholder="" name="nom_sous_categorie_up" id="nom_sous_categorie_up" value=""/>
                    </div>

                    <div class="dga-field fv-row">
                        <label>Catégorie</label>
                        <select class="dga-inp form-select" data-control="select2" data-placeholder="Choisir..." id="categorie_up" name="categorie_up">
                            <option></option>
                        </select>
                    </div>

                    <div class="dga-actions" style="padding:0;border-top:none;background:transparent;margin-top:1rem;">
                        <button type="reset" class="dga-cancel" onclick="closeSouscategorieUpdate()">Annuler</button>
                        <button type="submit" id="formSouscategorieUpdate_submit" class="dga-submit">
...
<script src="/personnel/basi-scripts.bundle.4.js"></script>
