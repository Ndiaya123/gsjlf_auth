                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            ...
                                            <div class="d-flex justify-content-end"
                                                ...
                                                <a href="#" class="btn btn-primary er fs-6 px-8 py-4"
                                                   data-bs-toggle="modal" data-bs-target="#kt_modal_new_sous_categorie">Ajouter</a>
...
<div class="modal fade" id="kt_modal_new_sous_categorie" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="formSouscategorie" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                               title="Le nom de la sous categorie doit être unique."></i>
                        </label>
                        <input type="text" class="form-control" placeholder="" name="nom_sous_categorie"
                               id="nom_sous_categorie" value=""/>
                    </div>
                    <div class="d-flex flex-column mb-7 fv-row">Sous categorie</label><br>
                        <select class="form-select" data-control="select2" data-placeholder="Choisir..." id="categorie" name="categorie">
                            <option></option>
                        </select>
                    </div>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" onclick="closeSouscategorie()">Annuler</button>
                        <button type="submit" id="formSouscategorie_submit" class="btn btn-primary">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="formSouscategorieUpdate" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nom_sous_categorie_up"
                               id="nom_sous_categorie_up" value=""/>
                    </div>


                    <div class="d-flex flex-column mb-7 fv-row">Sous categorie</label><br>
                        <select class="form-select" data-control="select2" data-placeholder="Choisir..." id="categorie_up" name="categorie_up">
                            <option></option>
                        </select>
                    </div>

                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" onclick="closeSouscategorieUpdate()">Annuler</button>
                        <button type="submit" id="formSouscategorieUpdate_submit" class="btn btn-primary">
