...
<head>
    ...
    <title>Gestion des livraisons — ENT GSJLF</title>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Comptabilité — livraisons des commandes d'achat</p>
                            </div>
                        ...
                        <div class="dga-card">
                            ...
                            <div class="dga-filters">
                                <div class="dga-filter-group">
                                    <label class="dga-filter-label" for="dga-annee-debut">Début</label>
                                    <select id="dga-annee-debut" class="dga-inp-annee"></select>
                                </div>
                                <span class="dga-annee-sep">à</span>
                                <div class="dga-filter-group">
                                    <label class="dga-filter-label" for="dga-annee-fin">Fin</label>
                            ...
                            <table id="dga-table-livraisons" class="display" style="width:100%">
                                <thead>
                                <tr>
                                    <th>N° commande</th>
                                    <th>Nom commande</th>
                        ...
                        <div class="modal fade dga-modal" id="modalNouvelleLivraison" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="dga-field">
                                            <label for="dgaCommande">Commande d'achat</label>
                                            <select id="dgaCommande" class="dga-inp">
                                                <option value="">Sélectionner une commande…</option>
                                            </select>
                                        </div>

                                        <div id="dgaBlocLignes" style="display:none;">
                                            <div class="dga-grid-2">
                                                <div class="dga-field">
                                                    <label for="dgaNumeroLivraison">N° de livraison <span style="color:#ef4444;">*</span></label>
                                                    <input type="text" id="dgaNumeroLivraison" class="dga-inp" required/>
                                                </div>
                                                <div class="dga-field">
                                                    <label for="dgaDateLivraison">Date de livraison</label>
                                                    <input type="date" id="dgaDateLivraison" class="dga-inp"/>
                                                </div>
                                            </div>

                                            <label style="display:block;font-size:.72rem;font-weight:700;color:#6b7280;margin-bottom:.3rem;">Lignes à livrer</label>
                                            ...
                                            <div class="dga-field" style="margin-top:1rem;">
                                                ...
                                                <input type="file" id="dgaFichierBL" class="dga-inp" accept="application/pdf,image/jpeg,image/png" required/>
                                            </div>

                                            <div class="dga-alerte-irreversible">
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="flex-shrink:0;"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                                                Cette opération est irréversible : aucun retour en arrière ne sera possible après validation.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dga-actions">
                                        <button type="button" class="dga-cancel" data-bs-dismiss="modal">Annuler</button>
                                        <button type="button" class="dga-submit" id="dgaSubmitLivraison" style="display:none;">
                        ...
                        <!-- ══ MODALE : Consulter ══ -->
                        <div class="modal fade dga-modal" id="modalConsulterLivraison" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
...
<script src="/personnel/basi-scripts.bundle.28.js"></script>
