...
<head>
    ...
    <title>Inventaire — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_13.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Création, suivi et validation des inventaires de stock</p>
                            </div>
                            <button id="dga-btn-nouvel-inventaire" class="dga-btn-primary" type="button">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                                Nouvel inventaire
                            </button>
                        </div>

                        <div class="dga-alerte-active" id="dga-alerte-active" style="display:none;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="flex-shrink:0;"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
                            <span id="dga-alerte-active-texte">Un inventaire est déjà en cours : impossible d'en créer un nouveau tant qu'il n'est pas terminé.</span>
                        </div>
                        ...
                        <div class="dga-card">
                            ...
                            <table id="dga-table-inventaires" class="display" style="width:100%">
                                <thead><tr><th>Référence</th><th>Date de début</th><th>Créé par</th><th>Nb. produits</th><th>Statut</th><th>Action</th></tr></thead>
                                <tbody></tbody>
                            </table>
                        </div>

                        <!-- MODALE : Valider -->
                        <div class="modal fade dga-modal" id="modalValiderInventaire" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 id="validerInvModalTitre">Validation de l'inventaire</h2>
                                    ...
                                    <div class="modal-body">
                                        <div id="dgaErreurValiderInv" class="dga-erreur-generale" style="display:none;"></div>
                                        <table class="dga-table-produits">
                                            <thead><tr><th>Catégorie</th><th>Sous-catégorie</th><th>Produit</th><th>Qté système</th><th>Qté opérateur</th><th>Qté validée</th></tr></thead>
                                            <tbody id="dgaCorpsValiderInv"></tbody>
                                        </table>
                                        <div class="dga-field" style="margin-top:1rem;">
                                            <label for="dgaObservationComptable">Observation <span style="color:#ef4444;">*</span></label>
                                            <textarea id="dgaObservationComptable" class="dga-inp" rows="2" required></textarea>
                                        </div>
                                    </div>
                                    <div class="dga-actions">
                                        <button type="button" class="dga-cancel" data-bs-dismiss="modal">Annuler</button>
                                        <button type="button" class="dga-submit" id="dgaBtnConfirmerValiderInv">
                                            <span>Valider</span>
                        ...
                        <!-- MODALE : Détail -->
                        <div class="modal fade dga-modal" id="modalDetailInventaire" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 id="detailInvModalTitre">Détail de l'inventaire</h2>
                                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black"/><rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="black"/></svg></span></div>
                                    </div>
                                    <div class="modal-body"><div id="dgaContenuDetailInv"></div></div>
                                    <div class="dga-actions">
                                        <button type="button" class="dga-cancel" data-bs-dismiss="modal">Fermer</button>
                                        <a href="#" target="_blank" class="dga-submit" id="dgaLienRapportPdf" style="text-decoration:none;">Rapport PDF</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="/personnel/basi-scripts.bundle.32.js"></script>
</body>
</html>