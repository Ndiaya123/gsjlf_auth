...
<head>
    ...
    <title>Alimentation de caisse — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_16.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Comptabilité — suivi des alimentations initiales et approvisionnements</p>
                            </div>
                        ...
                        <!-- MODALE : Nouvelle / Modifier alimentation -->
                        <div class="modal fade dga-modal" id="modalAlimentation" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 id="dgaModalTitre">Nouvelle alimentation</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="dga-field">
                                            <label for="dgaCaissier">Caissier</label>
                                            <select id="dgaCaissier" class="dga-inp">
                                                <option value="">Sélectionner…</option>
                                            </select>
                                        </div>

                                        <div class="dga-field">
                                            <label for="dgaDateAlimentation">Date d'alimentation</label>
                                            <input type="date" id="dgaDateAlimentation" class="dga-inp dga-inp-readonly" readonly/>
                                        </div>

                                        <div class="dga-field">
                                            <label>Type d'alimentation</label>
                                            <div class="dga-type-choix">
                                                <label class="dga-type-option" id="dgaTypeOption1">
                                                    <input type="radio" name="dgaTypeAC" value="1"/> Alimentation initiale
                                                </label>
                                                <label class="dga-type-option" id="dgaTypeOption2">
                                                    <input type="radio" name="dgaTypeAC" value="2"/> Approvisionnement
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dga-field">
                                            ...
                                            <div class="dga-montants-grid">
                                                <div class="dga-montant-field">
                                                    <label>Liquide (FCFA)</label>
                                                    <input type="number" id="dgaMontantLiquide" class="dga-inp" min="0" step="0.01" value="0"/>
                                                </div>
                                                <div class="dga-montant-field">
                                                    <label>Orange Money (FCFA)</label>
                                                    <input type="number" id="dgaMontantOM" class="dga-inp" min="0" step="0.01" value="0"/>
                                                </div>
                                                <div class="dga-montant-field">
                                                    <label>Wave (FCFA)</label>
                                                    <input type="number" id="dgaMontantWave" class="dga-inp" min="0" step="0.01" value="0"/>
                                                </div>
                                            </div>
                                            <div class="dga-montant-total">
                                                <span class="lbl">Montant total</span>
                                                <span class="val" id="dgaMontantTotalAffiche">0 FCFA</span>
                                            </div>
                                        </div>

                                        <div class="dga-field">
                                            <label for="dgaCommentaire">Commentaire</label>
                                            <textarea id="dgaCommentaire" class="dga-inp" rows="2"></textarea>
                                        </div>

                                    </div>
                                    <div class="dga-actions">
                                        <button type="button" class="dga-cancel" data-bs-dismiss="modal">Annuler</button>
                                        <button type="button" class="dga-submit" id="dgaSubmitAlimentation">
...
<script src="/personnel/basi-scripts.bundle.23.js"></script>
