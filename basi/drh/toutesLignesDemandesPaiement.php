...
<head>
    ...
    <title>Toutes les lignes de demandes de paiement — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_32.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="vd-hero">
                            <div class="vd-hero-left">
                                ...
                                <div class="vd-hero-title">
                                    <h1>Toutes les lignes de demandes de paiement</h1>
                                    <p>Lignes non épuisées, toutes demandes de paiement confondues</p>
                                </div>
                            </div>
                            <div class="vd-hero-right">
                                <span class="vd-badge" id="vd-compteur-lignes"></span>
                            </div>
                        </div>

                        <div class="vd-card">

                            <!-- Barre d'outils : sélection + action groupée -->
                            <div class="vd-toolbar">
                                <div class="vd-toolbar__selection" id="vd-selection-label">Aucune ligne sélectionnée</div>

                                <div class="vd-toolbar__actions">
                            ...
                            <!-- Table : toutes les lignes de paiement, toutes demandes confondues -->
                            <div class="vd-table-wrap" id="vd-panel-paiement">
...
<script src="/personnel/basi-scripts.bundle.18.js"></script>
