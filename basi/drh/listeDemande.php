...
<head>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_28.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="ld-hero">
                            <div class="ld-hero-title">
                                ...
                                <p>Demandes d'achat et de paiement — affichage par défaut des demandes en cours uniquement</p>
                            </div>
                        </div>

                        <!-- ══ FILTRES ══ -->
                        <div class="ld-filters">
                            <button class="ld-filter-btn active" id="ld-btn-toutes" data-filtre="toutes">
                                Toutes les demandes en cours
                            </button>
                            <button class="ld-filter-btn" id="ld-btn-achat" data-filtre="demande_achat">
                                Toutes les lignes demandes d'achat
                            </button>
                            <button class="ld-filter-btn" id="ld-btn-paiement" data-filtre="demande_paiement">
                                Toutes les lignes demandes de paiement
                            </button>
                        </div>
                        ...
                        <div class="ld-nav-links">
                            ...
                            <a href="/personnel/drh_toutes_les_lignes_de_demandes_de_paiement" class="ld-nav-btn">
                                ...
                                Voir toutes les lignes de demandes de paiement
                            </a>
                        </div>
                        ...
                        <div class="ld-card">
                            ...
                            <table id="ld-table-demandes" class="display" style="width:100%">
                                <thead><tr></tr></thead>
                                <tbody></tbody>
                            </table>
                        </div>
...
<script src="/personnel/basi-scripts.bundle.15.js"></script>
