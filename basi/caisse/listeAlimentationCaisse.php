...
<head>
    ...
    <title>Mes alimentations de caisse — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_1.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                <h1>
                                    ...
                                    Mes alimentations de caisse
                                </h1>
                                <p>Consultez vos alimentations et acceptez/rejetez celles en attente du jour</p>
                            </div>
                        </div>

                        <!-- ══ STATISTIQUES DU JOUR (Confirmées uniquement) ══ -->
                        <div class="dga-stats-jour">
                            <div class="dga-stat-jour dga-sj-total">
                                <div class="dga-stat-jour-icon">
                                ...
                                <div>
                                    <div class="dga-stat-jour-lbl">Montant total du jour</div>
                                    <div class="dga-stat-jour-val" id="dga-stat-total-jour">0 FCFA</div>
                                </div>
                            </div>
                            <div class="dga-stat-jour dga-sj-liquide">
                                <div class="dga-stat-jour-icon">
                                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/></svg>
                                </div>
                                <div>
                                    <div class="dga-stat-jour-lbl">Total Liquide du jour</div>
                                    <div class="dga-stat-jour-val" id="dga-stat-liquide-jour">0 FCFA</div>
                                </div>
                            </div>
                            <div class="dga-stat-jour dga-sj-wave">
                                <div class="dga-stat-jour-icon">
                                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M2 12c2-4 4-4 6 0s4 4 6 0 4-4 6 0"/></svg>
                                </div>
                                <div>
                                    <div class="dga-stat-jour-lbl">Total Wave du jour</div>
                                    <div class="dga-stat-jour-val" id="dga-stat-wave-jour">0 FCFA</div>
                                </div>
                            </div>
                            <div class="dga-stat-jour dga-sj-om">
                                <div class="dga-stat-jour-icon">
                                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
                                </div>
                                <div>
                                    <div class="dga-stat-jour-lbl">Total Orange Money du jour</div>
                                    <div class="dga-stat-jour-val" id="dga-stat-om-jour">0 FCFA</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dga-card">
                            ...
                            <table id="dga-table-alimentations" class="display" style="width:100%">
                                <thead>
                                <tr>
                                    <th>N°</th>
                                    <th>Montant total</th>
...
<script src="/personnel/basi-scripts.bundle.24.js"></script>
