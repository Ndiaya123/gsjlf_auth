...
<head>
    ...
    <title>Décision du DG — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_25.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Dossiers ayant reçu un avis favorable de la DFC, en attente de décision</p>
                            </div>
                        </div>
                        ...
                        <div class="dga-card">
                            ...
                            <table id="dga-table-dossiers" class="display" style="width:100%">
                                <thead>
                                <tr>
                                    <th>N° dossier</th>
                                    <th>Nom</th>
                        ...
                        <!-- MODALE : Détail du dossier -->
                        <div class="modal fade dga-modal" id="modalDetailDossier" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 id="dgaModalTitre">Détail du dossier</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="dga-bloc">
                                            ...
                                            <div id="dgaInfosGenerales"></div>
                                        </div>

                                        <div class="dga-bloc">
                                            <h3 class="dga-bloc-title">Lignes de la commande</h3>
                                        ...
                                        <div class="dga-bloc">
                                            <h3 class="dga-bloc-title" id="dgaTitreDocuments">Document(s)</h3>
...
<script src="/personnel/basi-scripts.bundle.21.js"></script>
