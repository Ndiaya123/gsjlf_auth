...
<head>
    ...
    <link rel="shortcut icon" href="/ressources/dist_assets/media/logos/logo_gsjlf.png"/>
    ...
    <link href="/ressources/dist_assets/css/style_basi_34.css" rel="stylesheet" type="text/css"/>
        ...
        <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true"
            ...
            <div class="aside-logo flex-column-auto text-center" id="kt_aside_logo">
                <a href="/responsable-financier-accueil" style="margin-left:65px;" id="lien_logo1">
                    <img alt="Logo" src="/ressources/dist_assets/media/logos/1.png" id="logo1" class="h-50px logo"/>
                </a>
            </div>
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="/responsable-financier-accueil" class="d-lg-none" id="lien_logo2">
                            <img alt="Logo" src="/ressources/dist_assets/media/logos/1.png" id="logo2" class="h-30px"/>
                        </a>
                    </div>
...
<script src="/scripts.bundle.gs.js"></script>
<script src="/basi-scripts.bundle.29.js"></script>
