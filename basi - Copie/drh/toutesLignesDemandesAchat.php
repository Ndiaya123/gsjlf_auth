...
<head>
    ...
    <title>Toutes les lignes de demandes d'achat — ENT GSJLF</title>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_31.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="vd-hero">
                            <div class="vd-hero-left">
                                ...
                                <div class="vd-hero-title">
                                    <h1>Toutes les lignes de demandes d'achat</h1>
                                    <p>Lignes non épuisées, toutes demandes d'achat confondues</p>
                                </div>
                            </div>
                        ...
                        <div class="vd-card">
                            ...
                            <!-- Table : toutes les lignes d'achat, toutes demandes confondues -->
                            <div class="vd-table-wrap" id="vd-panel-achat">
...
<script src="/personnel/basi-scripts.bundle.17.js"></script>
