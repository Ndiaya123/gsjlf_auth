...
<head>
    ...
    <link href="/personnel/ressources/dist_assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
          type="text/css"/>
    <link href="/personnel/ressources/dist_assets/css/style_basi_9.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="dga-hero">
                            <div class="dga-hero-title">
                                ...
                                <p>Créez et gérez les sous-rubriques budgétaires</p>
                            </div>
                            <a href="#" class="dga-btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_sous_rubrique">
                        ...
                        <div class="dga-card">
                            ...
                            <div class="dga-table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 dga-table" id="table_sous_rubrique">
                                        <thead>
                                        <tr class="fw-bolder text-muted">
                                            <th class="min-w-120px">N°</th>
                                            <th class="min-w-200px">Nom</th>
                                            <th class="min-w-200px">Rubrique</th>
...
<div class="modal fade dga-modal" id="kt_modal_new_sous_rubrique" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Nouvelle sous-rubrique</h2>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"
                     onclick="closeSousRubrique()">
                    <span class="svg-icon svg-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="modal-body">
                <form id="formSousRubrique" class="form" action="#">
                    <input type="hidden" name="option" value="7"/>
                    <div class="dga-field fv-row">
                        <label>Nom <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Le nom de la sous rubrique doit être unique."></i></label>
                        <input type="text" class="dga-inp form-control" placeholder="" name="nom_sous_rubrique" id="nom_sous_rubrique" value=""/>
                    </div>
                    <div class="dga-field fv-row">
                        <label>Rubrique</label>
                        <select class="dga-inp form-select" data-control="select2" data-placeholder="Choisir..." id="rubrique" name="rubrique">
                            <option></option>
                        </select>
                    </div>

                    <div class="dga-actions" style="padding:0;border-top:none;background:transparent;margin-top:1rem;">
                        <button type="reset" class="dga-cancel" onclick="closeSousRubrique()">Annuler</button>
                        <button type="submit" id="formSousRubrique_submit" class="dga-submit">
...
<div class="modal fade dga-modal" id="kt_modal_update_rubrique" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Modifier la sous-rubrique</h2>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"
                     onclick="closeSousRubriqueUpdate()">
                    <span class="svg-icon svg-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black"/>
                            <rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="black"/>
            ...
            <div class="modal-body">
                <form id="formSousRubriqueUpdate" class="form" action="#">
                    ...
                    <div class="dga-field fv-row">
                        <label>Nom <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Le nom de la sous-rubrique doit être unique."></i></label>
                        <input type="text" class="dga-inp form-control" placeholder="" name="nom_sous_rubrique_up" id="nom_sous_rubrique_up" value=""/>
                    </div>

                    <div class="dga-field fv-row">
                        <label>Rubrique</label>
                        <select class="dga-inp form-select" data-control="select2" data-placeholder="Choisir..." id="rubrique_up" name="rubrique_up">
                            <option></option>
                        </select>
                    </div>

                    <div class="dga-actions" style="padding:0;border-top:none;background:transparent;margin-top:1rem;">
                        <button type="reset" class="dga-cancel" onclick="closeSousRubriqueUpdate()">Annuler</button>
                        <button type="submit" id="formSousRubriqueUpdate_submit" class="dga-submit">
...
<script src="/personnel/basi-scripts.bundle.2.js"></script>
