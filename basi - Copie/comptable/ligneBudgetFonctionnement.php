...
if (empty($budgetToken)) { header('Location: /personnel/comptable-accueil'); exit; }
?><!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <title>Lignes de Budget Fonctionnement — ENT GSJLF</title>
...
<div class="d-flex flex-column flex-root"><div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
            <div class="aside-logo flex-column-auto text-center" id="kt_aside_logo">
                <a href="/personnel/comptable-accueil" style="margin-left:65px;" id="lien_logo1"><img alt="Logo" src="/personnel/ressources/dist_assets/media/logos/1.png" id="logo1" class="h-50px logo"/></a>
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_header" class="header align-items-stretch">
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0"><a href="/personnel/comptable-accueil" class="d-lg-none" id="lien_logo2"><img alt="Logo" src="/personnel/ressources/dist_assets/media/logos/1.png" id="logo2" class="h-30px"/></a></div>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.75rem;margin-bottom:1.25rem;">
                            <div style="display:flex;align-items:center;gap:.85rem;">
                                ...
                                <div>
                                    <div style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#1a7a5e;margin-bottom:.15rem;">Module Budget — Fonctionnement</div>
                        ...
                        <div class="lb-card">
                            <div class="lb-card-body" style="padding-bottom:.5rem;">
                                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.75rem;margin-bottom:1rem;">
                                    ...
                                    <div style="display:flex;gap:.5rem;align-items:center;flex-wrap:wrap;">
                                        <select id="lb-filter-categorie" class="lb-inp" style="min-width:170px;padding:.45rem .85rem;font-size:.82rem;">
    ...
    <div class="lb-modal">
        ...
        <div class="lb-modal-body">
            <form id="lb-form">
                ...
                <div class="lb-grid-2" id="lb-rub-block">
                    <div>
                        <label class="lb-lbl" for="lb-categorie">Catégorie <span style="color:#ef4444;">*</span></label>
                        <div style="display:flex;gap:.4rem;">
                            <select id="lb-categorie" class="lb-inp" style="flex:1;"><option value="">Choisir une catégorie</option></select>
                            <button type="button" id="lb-create-rub" class="lb-btn lb-btn--ghost" style="padding:.5rem .65rem;flex-shrink:0;min-width:36px;" title="Nouvelle catégorie">
                    ...
                    <div>
                        <label class="lb-lbl" for="lb-sous-rubrique">Sous-catégorie <span style="color:#ef4444;">*</span></label>
                        <div style="display:flex;gap:.4rem;">
                            <select id="lb-sous-rubrique" class="lb-inp" style="flex:1;"><option value="">Choisir une sous-catégorie</option></select>
                            <button type="button" id="lb-create-subrub" class="lb-btn lb-btn--ghost" style="padding:.5rem .65rem;flex-shrink:0;min-width:36px;" title="Nouvelle sous-catégorie">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                            </button>
                        </div>
                ...
                <div class="lb-field">
                    ...
                    <select id="lb-produit" class="lb-inp">
                        <option value="">— Sélectionner d'abord une sous-catégorie —</option>
                    </select>
                    <p class="lb-err-msg" id="err-produit"></p>
                </div>

                <div id="lb-qte-pu-row">
                ...
                <div class="lb-field" id="lb-description-block">
                ...
                <div class="lb-field" id="lb-periode-block">
...
<script src="/personnel/basi-scripts.bundle.9.js"></script>
</body>
</html>
