...
$tokenDemande = $_GET['token'] ?? '';
$tokenType    = $_GET['type']  ?? '';
if (!$tokenDemande) { header('Location: /personnel/chef-service-liste-demandes'); exit; }
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_10.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="al-hero">
                            <div class="al-hero-left">
                                <button id="al-btn-retour" class="al-back">
                                ...
                                <div class="al-hero-title">
                                    <h1>
                                        ...
                                        <span id="al-titre">Chargement…</span>
                                    </h1>
                                    <p id="al-sous-titre"></p>
                                </div>
                            </div>
                            <div class="al-hero-right">
                                <span id="al-badge-type"></span>
                                <span id="al-badge-statut"></span>
                                <!-- Bouton Soumettre (visible si En création) -->
                                <button id="al-btn-soumettre" class="al-btn al-btn-soumettre" style="display:none">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                ...
                                <button id="al-btn-terminer" class="al-btn al-btn-white">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                        ...
                        <div class="al-info-box">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1a7a5e" style="flex-shrink:0;margin-top:1px">
                                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
                            </svg>
                            <span>
                            Cochez les lignes à associer à cette demande.
                            <strong>Achat</strong> (nature = Produit) : saisir la quantité disponible.
                            <strong>Paiement</strong> (autre nature) : quantité = 1 automatiquement.
                            Filtrez par sous-catégories --> pour affiner l'affichage.
                        </span>
                        </div>
                        ...
                        <div class="al-card">
                            ...
                            <span class="al-card-title">
                                ...
                                Lignes disponibles du budget
                            </span>
                                <!-- Filtre service -->
                                <div class="al-filter-bar" style="padding:0;border:none;background:transparent">
                                    <div class="al-fg">
                                        <label class="al-flbl" for="al-sel-service">Filtre sous-catégories </label>
                                        <select id="al-sel-service" class="al-select" style="min-width:185px">
                                            <option value="">Tous les sous-catégories </option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Table lignes budget -->
                            <table id="al-table-budget" class="display" style="width:100%">
                                <thead><tr></tr></thead>
                                <tbody></tbody>
                            </table>

                            <!-- Barre d'action -->
                            <div class="al-action-bar">
                                <div class="al-sel-info">
                                    <span id="al-nb-sel">0</span>
                                    ligne(s) sélectionnée(s)
                                </div>
                                <button id="al-btn-valider" class="al-btn al-btn-primary" disabled>
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                        <polyline points="20 6 9 17 4 12"/>
                                    </svg>
                                    Valider
                        ...
                        <div class="al-card">
                            ...
                            <span class="al-card-title">
                                ...
                                Lignes associées à cette demande
                                <span class="al-count-badge" id="al-exist-count">0</span>
                            </span>
                            </div>
                            <table id="al-table-exist" class="display" style="width:100%">
                                <thead><tr></tr></thead>
                                <tbody></tbody>
                            </table>
                            <div class="al-total-bar">
                                <span class="lbl">Total :</span>
                                <span class="val" id="al-total-exist">0&nbsp;FCFA</span>
                            </div>
                        </div>
...
<!-- Tokens injectés par PHP — disponibles dès le chargement du JS -->
<script>
    window.AL_DEMANDE_TOKEN = <?php echo json_encode($tokenDemande); ?>;
    window.AL_TYPE_TOKEN    = <?php echo json_encode($tokenType);    ?>;
</script>
<script src="/personnel/basi-scripts.bundle.35.js"></script>
