...
<head>
    ...
    <link href="/personnel/ressources/dist_assets/css/style_basi_17.css" rel="stylesheet" type="text/css"/>
...
<!--                                    <span class="ld-badge-role">Chef de service</span>-->
                                ...
                                <p>Demandes d'achat et de paiement liées à vos budgets fonctionnement validés</p>
                            </div>
        ...
        <div class="ld-mbody">
            ...
            <div class="ld-fgroup" style="margin-bottom:1.25rem">
                ...
                <select id="ld-sel-type" class="ld-select" style="width:100%;min-width:unset">
                    ...
                    <option value="demande_achat" selected>🛒 Demande d'achat (Produit)</option>
                </select>
            </div>
...
<script src="/personnel/basi-scripts.bundle.34.js"></script>
