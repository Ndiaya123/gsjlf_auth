        ...
        validator.validate().then(function (status) {
            if (status == 'Valid') {
               // t.setAttribute('data-kt-indicator', 'on');
                ...
                t.innerHTML = '<span class="material-symbols-outlined" style="font-size:18px;animation:spin 1s linear infinite">progress_activity</span> Réinitialisation du mot de passe……';
                t.disabled  = true;
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (resp) {
                            ...
                            if (resp === "erreurConnexion") {
                                ...
                                showAlert("Adresse e-mail ou matricule incorrect", "error", null, false, t);
                               ...
                               // window.location.href = "/personnel/accueil";
                                ...
                                document.getElementById("email-display").value = document.getElementById("email1").value;
